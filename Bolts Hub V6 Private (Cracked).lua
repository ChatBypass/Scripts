...
Luazifier.TextLabel1.Text = "Cracked By"
...
Luazifier.TextLabel2.Text = "Tritemis ( 0◡0)っ✂╰⋃╯ yes its cutting ur penis."
...
local s = VLib:Window("Bolts Hub v6 Private", "Cracked By Tritemis", "FUCK")
...
Credits:Button('Click To Copy Discord Link',function()
	setclipboard("Nigga hub want to have acces to ur PC")
end)
...
Notification.new("info", "Hint", "Tritemis can lick ur dick for free") -- Args(<string> Type, <string> Heading, <string> Body, <boolean?> AutoRemoveNotif, <number?> AutoRemoveTime, <function?> OnCloseFunction)
